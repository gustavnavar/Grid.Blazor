...
using GridBlazorGrpc.Client.Pages;
using GridBlazorGrpc.Client.Resources;
...
namespace GridBlazorGrpc.Client.ColumnCollections
{
    public class ColumnCollections
    {
            ...
            OrderColumnsWithCrud = (c, customers, employees, shippers) =>
        {
            ...
            c.Add(o => o.CustomerID, true).SetSelectField(true, o => o.Customer.CustomerID + " - " + o.Customer.CompanyName, customers);

            /* Adding "EmployeeID" column: */
            c.Add(o => o.EmployeeID, true).SetSelectField(true, o => o.Employee.EmployeeID.ToString() + " - " + o.Employee.FirstName + " " + o.Employee.LastName, employees);

            /* Adding "ShipVia" column: */
            c.Add(o => o.ShipVia, true).SetSelectField(true, o => o.Shipper == null ? "" : o.Shipper.ShipperID.ToString() + " - " + o.Shipper.CompanyName, shippers);
        ...
        public static Action<IGridColumnCollection<Order>, Func<Order, Task<IEnumerable<SelectItem>>>,
            ...
            OrderColumnsWithNestedCrud = (c, customers, employees, shippers, subgrids) =>
        {
            /* Adding "OrderID" column: */
        ...
        public static Action<IGridColumnCollection<Order>, Func<Order, Task<IEnumerable<SelectItem>>>,
            Func<Order, Task<IEnumerable<SelectItem>>>, Func<Order, Task<IEnumerable<SelectItem>>>,
            Func<object[], bool, bool, bool, bool, Task<IGrid>>>
            OrderColumnsWithCreateGrid = (c, customers, employees, shippers, subgrids) =>
        {
            /* Adding "OrderID" column: */
            c.Add(o => o.OrderID).SetPrimaryKey(true).Titled(SharedResource.Number).SetTooltip("Order ID is ... ").SetWidth(100);
        ...
        public static Action<IGridColumnCollection<Order>, Func<Order, Task<IEnumerable<SelectItem>>>,
            Func<Order, Task<IEnumerable<SelectItem>>>, Func<Order, Task<IEnumerable<SelectItem>>>> 
            OrderColumnsWithCustomCrud = (c, customers, employees, shippers) =>
        {
            /* Adding "OrderID" column: */
            c.Add(o => o.OrderID).SetPrimaryKey(true).Titled(SharedResource.Number).SetWidth(100);
        ...
        public static Action<IGridColumnCollection<Order>, Func<Order, GridMode, Task>, Func<Order, Task<IEnumerable<SelectItem>>>,
            Func<Order, Task<IEnumerable<SelectItem>>>, Func<Order, Task<IEnumerable<SelectItem>>>> 
            OrderColumnsWithCrudAfterChange = (c, afterChangeCustomerID, customers, employees, shippers) =>
        {
            /* Adding "OrderID" column: */
            c.Add(o => o.OrderID).SetPrimaryKey(true).Titled(SharedResource.Number).SetWidth(100);
        ...
        public static Action<IGridColumnCollection<Order>, Func<Order, Task<IEnumerable<SelectItem>>>,
            Func<Order, Task<IEnumerable<SelectItem>>>, Func<Order, Task<IEnumerable<SelectItem>>>,
            IEnumerable<SelectItem>, IEnumerable<SelectItem>, IEnumerable<SelectItem>>
            OrderColumnsWithInlineCrud = (c, customers, employees, shippers, customerList, employeeList, shipperList) =>
            {
                /* Adding "OrderID" column: */
                c.Add(o => o.OrderID).SetPrimaryKey(true).Titled(SharedResource.Number).SetWidth(100);
                ...
                .SetSelectField(true, o => o.Customer == null ? "" : o.Customer.CustomerID + " - " + o.Customer.CompanyName, customers)
                .SetListFilter(customerList, true, true);
                ...
                .SetSelectField(true, o => o.Employee == null ? "" : o.Employee.EmployeeID.ToString() + " - " + o.Employee.FirstName + " " + o.Employee.LastName, employees)
                .SetListFilter(employeeList, true, true);

                /* Adding "ShipVia" column: */
                c.Add(o => o.ShipVia).Titled("Via")
                .SetWidth(250).RenderValueAs(o => o.Shipper == null ? "" : o.Shipper.CompanyName)
                .SetSelectField(true, o => o.Shipper == null ? "" : o.Shipper.ShipperID.ToString() + " - " + o.Shipper.CompanyName, shippers)
                .SetListFilter(shipperList, true, true);
        ...
        public static Action<IGridColumnCollection<Order>, Func<Order, Task<IEnumerable<SelectItem>>>, 
            Func<Order, Task<IEnumerable<SelectItem>>>, Func<Order, Task<IEnumerable<SelectItem>>>, IEnumerable<SelectItem>,
            IEnumerable<SelectItem>, Func<object[], bool, bool, bool, bool, Task<IGrid>>> 
            OrderColumnsAllFeatures = (c, customers, employees, shippers, customerList, shipperList, subgrids) =>
        {
            /* Adding "OrderID" column: */
            c.Add(o => o.OrderID).SetPrimaryKey(true).Titled(SharedResource.Number).SetTooltip("Order ID is ... ").SetWidth(100);
        ...
        public static Action<IGridColumnCollection<Order>, Func<Order, Task<IEnumerable<SelectItem>>>,
            Func<Order, Task<IEnumerable<SelectItem>>>, Func<Order, Task<IEnumerable<SelectItem>>>, IEnumerable<SelectItem>>
            VirtualizedOrderColumns = (c, customers, employees, shippers, list) =>
            {
                /* Adding "OrderID" column: */
                c.Add(o => o.OrderID).SetPrimaryKey(true).Titled(SharedResource.Number).SetTooltip("Order ID is ... ").SetWidth(100);
        ...
        public static Action<IGridColumnCollection<OrderDetail>, Func<Task<IEnumerable<SelectItem>>>> 
            OrderDetailColumnsCrud = (c, products) =>
        {
            /* Adding "OrderID" column: */
            c.Add(o => o.OrderID, true)
                .SetPrimaryKey(true)
            ...
            c.Add(o => o.ProductID)
                .SetPrimaryKey(true)
                .SetSelectField(true, o => o.Product.ProductID + " - " + o.Product.ProductName, products)
                .Titled("ProdId")
                .SetWidth(100);
        ...
        public static Action<IGridColumnCollection<OrderDetail>, Func<Task<IEnumerable<SelectItem>>>> 
            OrderDetailColumnsAllFeatures = (c, products) =>
        {
            /* Adding "OrderID" column: */
            c.Add(o => o.OrderID, true)
                .SetPrimaryKey(true)
