...
{
    public partial class TextFilterComponent<T>
    {
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            if (firstRender && firstSelect.Id != null && textFilter.Id != null)
            {
                ...
                {
                    if (sp != null && gridComponentSP != null && sp.X + sp.Width > Math.Min(sp.InnerWidth, 
                        gridComponentSP.X + gridComponentSP.Width + 25))
                    {
