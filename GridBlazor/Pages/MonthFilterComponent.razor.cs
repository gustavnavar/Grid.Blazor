...
namespace GridBlazor.Pages
{
    public partial class MonthFilterComponent<T>
    {
        ...
        {
            get { return GridDateTimeFormats.Placeholder(GridDateTimeFormats.MonthType, ColumnPattern); }
        }

        protected string DisplayValue(string value)
        {
            return GridDateTimeFormats.TransportToDisplay(value, GridDateTimeFormats.MonthType, ColumnPattern);
        }

        protected void SetDisplayValue(int index, string text)
        {
            _filters[index].Value = GridDateTimeFormats.DisplayToTransport(text, GridDateTimeFormats.MonthType, ColumnPattern);
        }
