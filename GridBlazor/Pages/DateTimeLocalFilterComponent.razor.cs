...
namespace GridBlazor.Pages
{
    public partial class DateTimeLocalFilterComponent<T>
    {
        ...
        {
            get { return GridDateTimeFormats.Placeholder(GridDateTimeFormats.DateTimeLocalType, ColumnPattern); }
        }

        protected string DisplayValue(string value)
        {
            return GridDateTimeFormats.TransportToDisplay(value, GridDateTimeFormats.DateTimeLocalType, ColumnPattern);
        }

        protected void SetDisplayValue(int index, string text)
        {
            _filters[index].Value = GridDateTimeFormats.DisplayToTransport(text, GridDateTimeFormats.DateTimeLocalType, ColumnPattern);
        }
