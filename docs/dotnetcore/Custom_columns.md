...
Remember that you can also enable sorting for all columns of a grid using the **Sortable** method of the **SGrid** object:
```razor
...
[<- Paging](Paging.md) | [Filtering ->](Filtering.md)