...
--------- | ----------- | -------
grpcService | lamba expresion of the client gRPC service method returning rows | gridClientService.GetOrdersGridRows
...
query | **IQueryCollection** containing all grid parameters | 
